	...
	public partial class Settings3D : Control
	{
		...
		public override void _Input(InputEvent @event)
		{
			...
			if (@event is InputEventKey eventKey && eventKey.Pressed)
			{
				...
				{
					AssignKey(eventKey, unshiftLockTextInput, ref global.unShiftLockKey, ref global.unShiftLockKeyValue); // jak kopijesz sprawdz tak z 3 razy ok? unshiftLockTextInput a nie shiftLockTextInput :)
					unshiftLockTextInput.Text = global.KeyBindValue["unShiftLockKey"];
				}
